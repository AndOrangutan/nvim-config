...
return packer.startup(function(use)
    ...
    use { "mrjones2014/legendary.nvim", -- Define your keymaps, commands, and autocommands as simple Lua tables, and create a legend for them at the same time, integrates with which-key.nvim.
        config = function () require("lengendary").setup() end,
    }
    ...
    use { "nvim-treesitter/nvim-treesitter-context", -- Shows floating hover with the current function/block context.
        config = function () pequire("configs.treesittercontext") end,
    }
    ...
    --{{{ Git
    use { "lewis6991/gisigns", -- Git integration: signs, hunk actions, blame, etc.
    config = function () require("configs.gisigns") end,
    }
    ...
    -- TODO: Add akinsho/git-conflict.nvim
    --}}}
    ...
    -- {{{ Indentation 
    use { "lukas-reineke/indent-blankline", -- IndentLine replacement in Lua with more features and treesitter support.
    ...
    -- {{{ UI
    use { "stevearc/dressin.nvim", -- Improve the built-in vim.ui interfaces with telescope, fzf, etc.
    ...
    -- {{{ Window Management
    use { "Pocco81/TrueZen", -- Clean and elegant distraction-free writing for NeoVim.
    ...
    use { "bullets.vim", -- Bullets.vim is a Vim/NeoVim plugin for automated bullet lists.
        ft = { "markdown", "text", "gitcommit", "scratch" },
        setup = function () require("configs.vimmarkdown") end,
    }
    -- TODO: Setup https://github.com/frabjous/knap with zathura :) !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
